...
public class User {
    ...
    public void setDateOfBirth(String data) throws IllegalArgumentException{
        try {
            ...
            throw new IllegalArgumentException("Ошибка ввода даты рождения");
        }
    }
    ...
    public void setPhoneNumber(String phoneNumber) throws IllegalArgumentException {
        if (phoneNumber.matches("^((8|7)[\\- ]?)?(\\(?\\d{3}\\)?[\\- ]?)?[\\d\\- ]{7,10}$")) {
            ...
            throw new IllegalArgumentException("Ошибка ввода номера телефона");
        }
    }
    ...
    public void setGender(Character gender) throws IllegalArgumentException {
        if (gender == 'm' || gender == 'f') {
            ...
            throw new IllegalArgumentException("Ошибка ввода пола");
        }
    }
